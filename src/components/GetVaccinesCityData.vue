  ...
  <v-row class="text-center">
    <v-col class="mb-5" cols="12" xs="6" sm="6" md="3" lg="3">
      <v-sheet class="pa-4" color="white" elevation="3">
        ...
        <v-progress-circular id="dosesDistLoader" indeterminate color="blue lighten-2"></v-progress-circular>
    ...
    <v-col class="mb-5" cols="12" xs="6" sm="6" md="3" lg="3">
      <v-sheet class="pa-4" color="white" elevation="3">
        ...
        <v-progress-circular id="dosesTotaisLoader" indeterminate color="blue lighten-2"></v-progress-circular>
    ...
    <v-col class="mb-5" cols="12" xs="6" sm="6" md="3" lg="3">
      <v-sheet class="pa-4" color="white" elevation="3">
        ...
        <v-progress-circular id="primeiraDoseLoader" indeterminate color="blue lighten-2"></v-progress-circular>
    ...
    <v-col class="mb-5" cols="12" xs="6" sm="6" md="3" lg="3">
      <v-sheet class="pa-4" color="white" elevation="3">
        ...
        <v-progress-circular id="segundaDoseLoader" indeterminate color="blue lighten-2"></v-progress-circular>
    ...
    <v-col class="mb-5" cols="12" xs="12" sm="12" md="6" lg="6">
      <v-sheet class="pa-4" color="white" elevation="3">
        <vc-donut :sections="chartporcPopulacaoVacinadaD1" has-legend legend-placement="bottom" :total="100" :start-angle="0" :auto-adjust-text-size="true">
          <h1 style="margin: 0;"><v-progress-circular id="ppvloader" indeterminate color="yellow lighten-2"></v-progress-circular>{{porcPopulacaoVacinada}}%</h1>população vacinada
        </vc-donut>
      </v-sheet>
    </v-col>
    <v-col class="mb-5" cols="12" xs="12" sm="12" md="6" lg="6">
      <v-sheet class="pa-4" color="white" elevation="3">
        <vc-donut :sections="chartporcPopulacaoVacinadaD2" has-legend legend-placement="bottom" :total="100" :start-angle="0" :auto-adjust-text-size="true">
          <h1 style="margin: 0;"><v-progress-circular id="ppv2loader" indeterminate color="light-green lighten-2"></v-progress-circular>{{porcPopulacaoVacinadaD2}}%</h1>população vacinada
        </vc-donut>
      </v-sheet>
    </v-col>
    <v-col class="mb-5" cols="12" xs="12" sm="12" md="12" lg="12">
      <v-sheet class="pa-4" color="white" elevation="3">
        <vc-donut :sections="chartporcDosesAplicadas" has-legend legend-placement="bottom" :total="100" :start-angle="0" :auto-adjust-text-size="true">
          <h1 style="margin: 0;"><v-progress-circular id="pdaloader" indeterminate color="blue lighten-2"></v-progress-circular>{{porcDosesAplicadas}}%</h1>doses aplicadas
        </vc-donut>
      </v-sheet>
    </v-col>
...
<script>
  ...
  const numporcDosesAplicadas = parseFloat(localStorage.getItem("pdaT"));
      ...
      fetch("https://cors.bridged.cc/https://www.saopaulo.sp.gov.br/wp-content/uploads/" + data.getFullYear() + "/" +
        ...
        .then(async response => {
          ...
          for (var i = 0; i < citydatajson.length; i++) {
            if (citydatajson[i].Município === 'TANABI') {
          ...
          this.porcPopulacaoVacinada = (this.primeiraDose / 26101) * 100;
          ...
          this.porcPopulacaoVacinadaD2 = (this.segundaDose / 26101) * 100;
