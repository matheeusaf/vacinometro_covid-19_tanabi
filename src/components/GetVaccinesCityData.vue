  ...
  <v-row class="text-center">
    <v-col class="mb-5" cols="12" xs="6" sm="6" md="3" lg="3">
      <v-sheet class="pa-4" elevation="3">
        ...
        <v-progress-circular id="doseUnicaLoader" indeterminate color="blue lighten-2"></v-progress-circular>
    ...
    <v-col class="mb-5" cols="12" xs="12" sm="12" md="3" lg="3">
      <v-sheet class="pa-4" elevation="3">
        <vc-donut :sections="chartporcPopulacaoVacinadaDU" has-legend legend-placement="bottom" :total="100"
          ...
          <h1 style="margin: 0;">
            <v-progress-circular id="ppuloader" indeterminate color="green lighten-2"></v-progress-circular>
    ...
    <v-col class="mb-5" cols="12" xs="12" sm="12" md="3" lg="3">
      <v-sheet class="pa-4" elevation="3">
        <vc-donut :sections="chartporcPopulacaoVacinadaD1" has-legend legend-placement="bottom" :total="100"
          :start-angle="0" :auto-adjust-text-size="true">
          <h1 style="margin: 0;">
            <v-progress-circular id="ppvloader" indeterminate color="yellow lighten-2"></v-progress-circular>
    ...
    <v-col class="mb-5" cols="12" xs="12" sm="12" md="3" lg="3">
      <v-sheet class="pa-4" elevation="3">
        <vc-donut :sections="chartporcPopulacaoVacinadaD2" has-legend legend-placement="bottom" :total="100"
          :start-angle="0" :auto-adjust-text-size="true">
          <h1 style="margin: 0;">
            <v-progress-circular id="ppv2loader" indeterminate color="lime lighten-2"></v-progress-circular>
    ...
    <v-col class="mb-5" cols="12" xs="12" sm="12" md="3" lg="3">
      <v-sheet class="pa-4" elevation="3">
        <vc-donut :sections="chartporcPopulacaoVacinadaD3" has-legend legend-placement="bottom" :total="100"
          :start-angle="0" :auto-adjust-text-size="true">
          <h1 style="margin: 0;">
            <v-progress-circular id="ppv3loader" indeterminate color="blue lighten-2"></v-progress-circular>
